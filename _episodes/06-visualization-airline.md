...
# Instead, please edit 06-visualization-airline.md in _episodes_rmd/
...
<img src="../fig/rmd-06-noalpha-1.png" title="Arrival Delays vs Departure Delays for Alaska Airlines flights from NYC in 2013" alt="Arrival Delays vs Departure Delays for Alaska Airlines flights from NYC in 2013" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-nolayers-1.png" title="Plot with No Layers" alt="Plot with No Layers" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-alpha-1.png" title="Delay scatterplot with alpha=0.2" alt="Delay scatterplot with alpha=0.2" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-jitter-1.png" title="Jittered delay scatterplot" alt="Jittered delay scatterplot" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-hourlytemp-1.png" title="Hourly Temperature in Newark for January 1-15, 2013" alt="Hourly Temperature in Newark for January 1-15, 2013" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-unnamed-chunk-13-1.png" title="Plot of Hourly Temperature Recordings from NYC in 2013" alt="Plot of Hourly Temperature Recordings from NYC in 2013" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-unnamed-chunk-14-1.png" title="Histogram of Hourly Temperature Recordings from NYC in 2013" alt="Histogram of Hourly Temperature Recordings from NYC in 2013" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-unnamed-chunk-15-1.png" title="Histogram of Hourly Temperature Recordings from NYC in 2013 - 60 Bins" alt="Histogram of Hourly Temperature Recordings from NYC in 2013 - 60 Bins" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-unnamed-chunk-16-1.png" title="Histogram of Hourly Temperature Recordings from NYC in 2013 - 60 Colored Bins" alt="Histogram of Hourly Temperature Recordings from NYC in 2013 - 60 Colored Bins" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-unnamed-chunk-17-1.png" title="Histogram of Hourly Temperature Recordings from NYC in 2013 - Binwidth = 10" alt="Histogram of Hourly Temperature Recordings from NYC in 2013 - Binwidth = 10" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-facethistogram-1.png" title="Faceted histogram" alt="Faceted histogram" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-badbox-1.png" title="Invalid boxplot specification" alt="Invalid boxplot specification" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-monthtempbox-1.png" title="Month by temp boxplot" alt="Month by temp boxplot" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-monthtempbox2-1.png" title="November boxplot" alt="November boxplot" width="\textwidth" style="display: block; margin: auto;" />

Now let's plot all 2141 temperature recordings for November on top of the boxplot in Figure \@ref(fig:monthtempbox3).

<img src="../fig/rmd-06-monthtempbox3-1.png" title="November boxplot with points" alt="November boxplot with points" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-flightsbar-1.png" title="(ref:geombar)" alt="(ref:geombar)" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-flightscol-1.png" title="(ref:geomcol)" alt="(ref:geomcol)" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-carrierpie-1.png" title="The dreaded pie chart" alt="The dreaded pie chart" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-unnamed-chunk-36-1.png" title="Stacked barplot comparing the number of flights by carrier and airport" alt="Stacked barplot comparing the number of flights by carrier and airport" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-unnamed-chunk-39-1.png" title="Side-by-side AKA dodged barplot comparing the number of flights by carrier and airport" alt="Side-by-side AKA dodged barplot comparing the number of flights by carrier and airport" width="\textwidth" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-06-facet-bar-vert-1.png" title="Faceted barplot comparing the number of flights by carrier and airport" alt="Faceted barplot comparing the number of flights by carrier and airport" width="\textwidth" style="display: block; margin: auto;" />
